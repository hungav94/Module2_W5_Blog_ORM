...
public class BlogController {
    ...
    @GetMapping("/blog")
    public ModelAndView listBlog(@RequestParam("s") Optional<String> s, @PageableDefault(size = 2) Pageable pageable) {
        Page<Blog> blogs;
        if (s.isPresent()) {
    ...
    public ModelAndView showBlogForm(@PathVariable Long id) {
        Blog blog = blogService.findById(id);
        if (blog != null) {
